...
namespace Antohny_3ipr
{
    public partial class Form1 : Form
    {
        ...
        //шифровать
        private void buttonEncrypt_Click_Click(object sender, EventArgs e)
        {
            if ((textBox_p.Text.Length > 0) && (textBox_q.Text.Length > 0) && (sourceFilePathTextBox.Text.Length > 0) && (signFilePathTextBox.Text.Length > 0))
            {
                ...
                if (IsTheNumberSimple(p) && IsTheNumberSimple(q))
                {
                    ...
                    MessageBox.Show("p или q - не простые");
            }
            else
                MessageBox.Show("Введите данные");
        }

        private void buttonDecipher_Click_Click(object sender, EventArgs e)
        {
        ...
        private void sourceFileButton_Click_Click(object sender, EventArgs e)
        {
        ...
        private void signFileButton_Click_Click(object sender, EventArgs e)
        {
            OpenFileDialog ofd = new OpenFileDialog();
